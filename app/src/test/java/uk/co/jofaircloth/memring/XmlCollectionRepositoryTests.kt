...
import uk.co.jofaircloth.memring.data.xml.CollectionRepository

class XmlCollectionRepositoryTests {

    @Test
    fun deserializeXml() {
        val collection = CollectionRepository().deserializeCollection()
